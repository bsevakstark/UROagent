...
The tool converts the incoming clinical question into an embedding,
finds the top-k most semantically similar guideline chunks, and returns
them as formatted context for the LLM to reason over.
"""
...
TOP_K = 3          # number of guideline chunks to retrieve
